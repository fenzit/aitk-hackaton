<template>
  <footer class="border-t border-slate-200 bg-white pt-16 pb-8 px-6">
    <div class="max-w-6xl mx-auto">
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
        <div class="col-span-2 lg:col-span-2">
          <div class="flex items-center gap-2 mb-6">
            <div class="w-6 h-6 bg-slate-900 rounded-sm"></div>
            <span class="font-bold text-lg tracking-tight text-slate-900">Neutron AI</span>
          </div>
          <p class="text-slate-500 text-sm max-w-xs leading-relaxed">
            Beautifully designed infrastructure primitives for AI applications. Built for velocity and scale.
          </p>
        </div>
        <div>
          ...
          <ul class="space-y-3 text-sm text-slate-600">
            ...
            <li><a href="#" class="hover:text-primary-600">Pricing</a></li>
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm text-slate-600">
            <li><a href="#" class="hover:text-primary-600">About</a></li>
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm text-slate-600">
            ...
            <li><a href="#" class="hover:text-primary-600">Cookie Policy</a></li>
          </ul>
        </div>
      </div>
      <div class="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="text-sm text-slate-500">
          &copy; {{ new Date().getFullYear() }} Neutron AI Inc. All rights reserved.
        </div>
